...
# high-z data meta
xpath = '/media/bartosz/USB STICK/samlaihei XQz5 main Spectral_Data/'
xmeta = np.loadtxt(xpath+'XQz5_meta.txt', dtype='str', delimiter='\t')
xnames = xmeta[:,0]
xZ = xmeta[:,1]
...
with open(xpath + 'lhr_NN_full_sc.txt','w') as nnsave:
    for x in result:
        nnsave.write('{} \t {} \t{} \t{} \t{} \t{} \t {} \t{} \t{} \t{} \t{} \n'.format(*x))
nnsave.close()
